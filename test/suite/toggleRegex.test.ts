...
suite('Toggle Regex Unit Tests', () => {
  ...
  test('main.js handleRegexToggle title should include descriptive text', () => {
    ...
    assert.ok(toggleFn.includes('Regex mode enabled'), 'handleRegexToggle title should describe enabled state');
    assert.ok(toggleFn.includes('Toggle regex search mode'), 'handleRegexToggle title should describe disabled state');
  });
