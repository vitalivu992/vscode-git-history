...
suite('Git Service Integration Tests', () => {
  ...
  test.skip('getSelectionHistory should respect maxCommits configuration', async () => {
    const { execSync } = require('child_process');
  ...
  test.skip('getFileContentAtCommit should return file content at specific commit', async () => {
    const commits = await getFileHistory(testFile, tempDir);
  ...
  test.skip('getCommitRangeDiff should show cumulative changes between commits', async () => {
    const { execSync } = require('child_process');
    const commits = await getFileHistory(testFile, tempDir);
    assert.ok(commits.length >= 2, 'Should have at least 2 commits');
...
suite('Commit URL Generation Tests', () => {
  suite('parseRemoteUrl', () => {
    ...
    test.skip('parses GitHub Enterprise URLs (github.company.com)', () => {
    ...
    test.skip('returns null for unknown platforms', () => {
  ...
  suite('parseRemoteUrl - SSH URLs with custom ports', () => {
    ...
    test.skip('parses ssh:// URLs for GitHub Enterprise', () => {
    ...
    test.skip('parses ssh:// URLs with nested groups', () => {
  ...
  suite('checkoutBranch', () => {
    ...
    test.skip('should throw error with uncommitted changes', async () => {
  ...
  suite('getCommitUrl', () => {
    ...
    test.skip('should generate GitHub Enterprise URL', async () => {
    ...
    test.skip('should generate URL from ssh:// with custom port 2222', async () => {
