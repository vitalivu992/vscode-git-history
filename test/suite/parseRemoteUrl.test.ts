...
suite('parseRemoteUrl Tests', () => {
  ...
  suite('parseRemoteUrl function - Edge Cases', () => {
    ...
    test.skip('URL with query parameters should return null', () => {
      assert.strictEqual(parseRemoteUrl('https://github.com/owner/repo?query=1'), null);
    });

    test.skip('URL with fragment should return null', () => {
      assert.strictEqual(parseRemoteUrl('https://github.com/owner/repo#section'), null);
    });

    test.skip('URL with query parameters and fragment should return null', () => {
    ...
    test.skip('multiple @ in SSH URL should return null', () => {
