...
suite('Toggle Hide Merge Commits Unit Tests', () => {
  ...
  test('main.js handleMergeToggle title should include descriptive text when enabled', () => {
    ...
    assert.ok(toggleFn.includes('Merge commits hidden (click to show)'), 'handleMergeToggle title should describe hidden state');
    assert.ok(toggleFn.includes('Hide merge commits'), 'handleMergeToggle title should describe visible state');
  });
  ...
  suite('README Documentation Verification', () => {
    ...
    test('README should document Hide Merge Commits feature', () => {
      ...
      assert.ok(source.includes('Hide Merge Commits'),
