...
suite('Toolbar Tooltips', function () {
  test('index.html has keyboard shortcuts in button tooltips', function () {
    ...
    assert.ok(html.includes('Ctrl+Shift+Alt+T'), 'Stats toggle should mention Ctrl+Shift+Alt+T');
  ...
  test('main.js handleToggleGraph includes shortcut in title updates', function () {
    ...
    assert.ok(source.includes("Ctrl+Shift+Alt+T to toggle"), 'handleToggleStats should include Ctrl+Shift+Alt+T');
  ...
  test('webviewProvider.ts has keyboard shortcuts in button tooltips', function () {
    ...
    assert.ok(source.includes('Ctrl+Shift+Alt+T'), 'webviewProvider should mention Ctrl+Shift+Alt+T');
  ...
  test('main.js hidden state tooltips include shortcuts', function () {
    ...
    assert.ok(source.includes("'Show stats column (Ctrl+Shift+Alt+T)'"), 'Hidden stats tooltip should include shortcut');
