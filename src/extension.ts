...
export function activate(context: vscode.ExtensionContext) {
  ...
  const webviewActions = [
    ...
    { command: 'gitHistory.copyShowCommand', action: 'copyShowCommand' },
    { command: 'gitHistory.copyFileShowCommand', action: 'copyFileShowCommand' },
    ...
    { command: 'gitHistory.copyFileStats', action: 'copyFileStats' },
    { command: 'gitHistory.copyFilesChangedCount', action: 'copyFilesChangedCount' },
    { command: 'gitHistory.copyCommitWithStats', action: 'copyCommitWithStats' },
    { command: 'gitHistory.copyFullCommitInfoWithFileStats', action: 'copyFullCommitInfoWithFileStats' },
    ...
    { command: 'gitHistory.copyCommitHtml', action: 'copyCommitHtml' },
    { command: 'gitHistory.copyCommitRest', action: 'copyCommitRest' },
    { command: 'gitHistory.copyCommitJira', action: 'copyCommitJira' },
    ...
    { command: 'gitHistory.copyFileBasename', action: 'copyFileBasename' },
    ...
    { command: 'gitHistory.copySelectedMessagesNumberedWithAuthor', action: 'copySelectedMessagesNumberedWithAuthor' },
    { command: 'gitHistory.exportCommits', action: 'exportCommits' },
    { command: 'gitHistory.exportCommitsMbox', action: 'exportCommitsMbox' },
    ...
    { command: 'gitHistory.renameFilterPreset', action: 'renameFilterPreset' },
